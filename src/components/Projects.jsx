...
const Projects = () => {
  ...
  const projectData = [
    ...
    { name: "E-Shop", img: eshop , discription: "Responsive front-end Ecommerce website using React JS, Redux, and Tailwind CSS, creating a smooth and interactive user experience." },
  ];
      ...
      <div className="bg-white text-white h-full relative">
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-12 rounded-lg shadow-lg relative max-w-sm mx-auto">
              ...
              <a
                href=" https://github.com/KaizenBuild"
    ...
    <div className="project-card w-[90%] md:w-[450px] h-[250px] relative bg-white m-auto mb-8 rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500 to-purple-800 rounded-lg overflow-hidden transform rotate-y-180 opacity-0 hover:opacity-100 transition-opacity duration-300">
        <div className="flex flex-col justify-center items-center h-full text-white">
          ...
          <a href="https://kaizenbuild.github.io/e-Shop/" target="0" className="mt-4 px-4 py-2 bg-white text-purple-800 rounded-lg hover:bg-purple-200 transition-all duration-300">
            Take a Tour
          </a>
        </div>
      </div>
